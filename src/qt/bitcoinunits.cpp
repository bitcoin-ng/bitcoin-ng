...
{
    switch (unit) {
    case Unit::BTC: return QString("BNG");
    case Unit::mBTC: return QString("mBNG");
    case Unit::uBTC: return QString::fromUtf8("µBNG (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("BitcoinNG");
    case Unit::mBTC: return QString("Milli-BitcoinNG (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-BitcoinNG (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
