...
public:
    CMainParams() {
        ...
        // BNG genesis uses nBits=0x1f00ffff, so the PoW limit must allow that target.
        // The corresponding maximum target is 0000ffff00000000000000000000000000000000000000000000000000000000.
        ...
        vSeeds.clear();
        vSeeds.emplace_back("seed.bng.example.com."); // TODO: Add real seeds
...
public:
    CTestNetParams() {
        ...
        // BNG testnet genesis uses nBits=0x1f00ffff.
        consensus.powLimit = uint256{"0000ffff00000000000000000000000000000000000000000000000000000000"};
        consensus.nPowTargetTimespan = 14 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 10 * 60;
        ...
        // BNG Testnet Magic Bytes: BNG\x02
        pchMessageStart[0] = 0x42;
        pchMessageStart[1] = 0x4e;
        pchMessageStart[2] = 0x47;
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        // BNG Regtest Magic Bytes: BNG\x03
        pchMessageStart[0] = 0x42;
        pchMessageStart[1] = 0x4e;
        pchMessageStart[2] = 0x47;
        ...
        m_assumeutxo_data = {
            {   // For use by unit tests
                ...
                .blockhash = consteval_ctor(uint256{"110942f335b306cf61680ecfd5008426c02670c6f18608efe6bdc872c475b29a"}),
            },
            {
