...
MAGIC_BYTES = {
    "mainnet": b"\x42\x4e\x47\x01",   # BNG\x01
    "testnet3": b"\x42\x4e\x47\x02",  # BNG\x02
    "regtest": b"\x42\x4e\x47\x03",   # BNG\x03
    # Signet magic is derived from the challenge; default challenge matches Bitcoin's
